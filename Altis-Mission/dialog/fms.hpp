class fms_system {
    ...
    class controlsBackground {
      ...
      {
      	idc = -1;
      	text = "<t font='PuristaBold' align='right' size='1.5'>FMS | Behörden Funkmeldesystem</t>"; //--- ToDo: Localize;
      ...
      {
      	idc = -1;
      	text = "Gebietskürzel:"; //--- ToDo: Localize;
      ...
      {
      	idc = -1;
      	text = "Gebietübersicht/Gebietsauswahl"; //--- ToDo: Localize;
      ...
      {
      	idc = -1;
      	text = "Ausgewähltes Gebiet:"; //--- ToDo: Localize;
      	x = 0.572187 * safezoneW + safezoneX;
