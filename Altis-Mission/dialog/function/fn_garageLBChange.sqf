...
[_trunkSpace, "Keiner"] select (_trunkSpace isEqualTo -1),
(_vehicleInfo select 12),
_vehicleColor,
(_dataArr select 2),
([(_dataArr select 0), "Kein Material vorhanden"] select ((_dataArr select 3) isEqualTo [])),
(["Nicht Versichert", "Versichert"] select (_dataArr select 4))
];
