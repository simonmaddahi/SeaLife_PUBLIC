...
with uiNamespace do {
	...
	_cur = (call _display) ctrlCreate ["RscButton", -1];
	_cur ctrlSetText "1";
	...
	_cur = (call _display) ctrlCreate ["RscText", -1];
	...
	_cur call _sideColor; //ctrlSetBackgroundColor [1,1,1,1];
	_cur ctrlCommit 0;
	_cur ctrlSetTooltip "Sperrzonensystem von Stig";
	_cur buttonSetAction "";
	_cur call _pushIntoArray;
	...
	*/
	player createDiarySubject ["sperrzonensystem","Sperrzonenverwaltung"];
