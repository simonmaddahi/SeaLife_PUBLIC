...
if(_opfer getVariable ["esg_stabinpro",false]) exitWith {["Stabilisierung", "Diese Person wird schon stabilisiert!", true, "fast"] spawn ESG_fnc_notify;};
if((_opfer getVariable ["esg_bewusstlos_stab",0]) >= 3)exitWith{["Stabilisierung", "Verwundete können nur 3 mal stabilisiert werden!", true, "fast"] spawn ESG_fnc_notify;};
...
for "_i" from 0 to 1 step 0 do {
	_opfer setVariable ["esg_bewusstlos_delay", ((_opfer getVariable ["esg_bewusstlos_delay",0]) + 2), true];
...
["Stabilisierung", "Du hast erfolgreich das Opfer stabilisiert. Er wird nun länger überleben.", false, "fast"] spawn ESG_fnc_notify;
