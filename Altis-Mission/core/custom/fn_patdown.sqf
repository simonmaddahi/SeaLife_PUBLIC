...
if (life_isknocked || life_interrupted || (player getVariable ["restrained",false]) || (player distance _target > 4) || !alive _target || !alive player) exitWith {["Aktion abgebrochen","Die Aktion wurde abgebrochen!", true, "fast"] spawn ESG_fnc_notify;};
...
["Person ausziehen","Sachen der Person wurden auf den Boden gelegt.", false, "fast"] spawn ESG_fnc_notify;
