...
switch (_mode) do {
	...
	case "size": {
		{
			if (!(_x in ["safezone_markt_map", "rebellencity", "turtle_1", "turtle_2"])) then {
	...
	case "extra_menu": {
		...
		if (!(profileNameSpace getVariable "filter_extra")) then
		{
			...
			_title_extra ctrlSetStructuredText parseText "<t size='1'>Extra Kartenfilter</t>";
			...
			_txt_atm ctrlSetStructuredText parseText "<t size='1'>Bankautomaten</t>";
			...
			_txt_tanke ctrlSetStructuredText parseText "<t size='1'>Tankstellen</t>";
			...
			_txt_sons ctrlSetStructuredText parseText "<t size='1'>Sonstiges</t>";
			...
			_txt_lh ctrlSetStructuredText parseText "<t size='1'>Legale Händler</t>";
			...
			_txt_Ih ctrlSetStructuredText parseText "<t size='1'>Illegale Händler</t>";
