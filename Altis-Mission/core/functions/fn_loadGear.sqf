...
private _handle = 0 spawn life_fnc_stripDownPlayer;
...
} forEach (_itemArray select (count _itemArray)-1);

life_maxWeight = 24;

_itemArray deleteAt (count _itemArray-1);
