...
for "_i" from 0 to 1 step 0 do {
	...
	_logo ctrlCommit 0;
    _abortButton = CONTROL(49,104);
    _abortButton buttonSetAction "[] call SOCK_fnc_updateRequest; [player] remoteExec [""TON_fnc_cleanupRequest"",2]; [0,""STR_lobbytschau"",true,[(player getVariable [""realname"",name player])]] remoteExecCall [""life_fnc_broadcast"",-2];";
    ...
    _topButton ctrlSetText format ["%1","SeaLife-Gaming.de"];
    _saveButton ctrlEnable false;
    _saveButton ctrlSetText format ["%1","ts.SeaLife-gaming.de"];
