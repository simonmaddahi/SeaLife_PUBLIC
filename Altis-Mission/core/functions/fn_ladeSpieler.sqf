...
switch (_mode) do {
    case 0: {
        ...
        */
        ...
        _contenttext = '<br/><t font="PuristaBold" align="center">Serverteam</t><br/><t size="1.1" color="#FF0000">Projektleitung:</t><br/>    - FLAKE<br/>    - Melvin<br/><br/><t size="1.1" color="#FF0000">Core-Management:</t><br/>    - XXX <br/>    - XXX <br/><br/><t size="1.1" color="#00AB47">Supportleitung:</t><br/>    - John Parker <br/><br/><t size="1.1" color="#ff00bf">Community-Management:</t><br/>    - RosaChicken | Steve <br/><br/><t size="1.1" color="#0088FF">Entwickler:</t><br/>    - Natic <br/>    - XXX <br/><br/><t font="PuristaBold" align="center">Fraktionsleitungen</t><br/><t size="1.1" color="#0069C4">Polizeidirektor:</t><br/>    - Leonardo Butters <br/><br/><t size="1.1" color="#00ff00">Branddirektor:</t><br/>    - Dr. Thomas Schneider <br/>    - Dr. Max waldschmidt';
