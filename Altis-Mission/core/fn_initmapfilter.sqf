...
{
	if ((!(_x in marker_all1)) && (!(_x isEqualto "safezone_markt_map"))) then {
...
_title ctrlCommit 0;
_title ctrlSetStructuredText parseText "<t size='1'>Kartenfilter</t>";
...
_txt_felder ctrlSetStructuredText parseText "<t size='1'>Resourcen</t>";
...
_txt_verarbeiter ctrlSetStructuredText parseText "<t size='1'>Verarbeiter</t>";
...
_txt_haendler ctrlSetStructuredText parseText "<t size='1'>Händler</t>";
...
_txt_garagen ctrlSetStructuredText parseText "<t size='1'>Garagen</t>";
...
_txt_shops ctrlSetStructuredText parseText "<t size='1'>Shops</t>";
...
_txt_dp ctrlSetStructuredText parseText "<t size='1'>DP Missionen</t>";
...
_txt_cop ctrlSetStructuredText parseText "<t size='1'>Polizei</t>";
...
_txt_med ctrlSetStructuredText parseText "<t size='1'>Medic</t>";
...
_txt_reb ctrlSetStructuredText parseText "<t size='1'>Rebellen</t>";
...
_txt_size ctrlSetStructuredText parseText "<t size='1'>Größe der Marker:</t>";
