/*
   ...
   Description:
   Civilists can Spray on all Objects
*/
...
if (_intersections isEqualTo []) exitWith {
  ...
  ["Es konnte leider keine Oberfläche gefunden werden", false, "fast"] spawn ESG_fnc_notify;
};
...
if ( !([ 0.5 * 0.6, 0.5 * 0.6] call _fnc_isOk) ||
    ...
    {!([-0.5 * 0.6,-0.5 * 0.6] call _fnc_isOk)}}}) exitWith {
       ...
       ["Die Oberfläche ist zu klein", false, "fast"] spawn ESG_fnc_notify;
    false
};
