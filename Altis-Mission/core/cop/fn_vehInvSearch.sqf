...
if (count _vehicleInfo isEqualTo 0) exitWith {["Fahrzeug leer","Dieses Fahrzeug ist leer", true, "fast"] spawn ESG_fnc_notify;};
...
if (_value > 0) then {
    ...
    ["Fahrzeug Durchsuchung","Nichts Illegales in diesem Fahrzeug", false, "fast"] spawn ESG_fnc_notify;
};
