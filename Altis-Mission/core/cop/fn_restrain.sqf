...
while {player getVariable  "restrained"} do {
    if (isNull objectParent player) then {
        _anim = player getVariable ["restrainAnim", "AmovPercMstpSnonWnonDnon_Ease"];
    ...
    waitUntil {animationState player != (player getVariable ["restrainAnim", "AmovPercMstpSnonWnonDnon_Ease"]) || !(player getVariable "restrained") || vehicle player != _state};
