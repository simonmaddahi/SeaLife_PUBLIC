...
if(! ([_time] call TON_fnc_isnumber)) exitWith {
 	["Keine Zahl","Die eingegebene Zahl ist keine richtige Zahl", true, "fast"] spawn ESG_fnc_notify;
};
_time = parseNumber _time; //requested number
_time = round _time;
if(_time < 5 || _time > 90) exitWith {["Falsche Zeitangabe","Du kannst Personen nur zwischen 5-90 Minuten inhaftieren!", true, "fast"] spawn ESG_fnc_notify;};
closeDialog 0;
