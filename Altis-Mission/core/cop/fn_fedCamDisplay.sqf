...
if (!isPiPEnabled) exitWith {["BiB deaktiviert","Um diese Aktion nutzen zu können, muss du die Einstellung ""Bild in Bild"" aktivieren.", true, "fast"] spawn ESG_fnc_notify;};
