...
/*
	...
	if (getNumber(missionConfigFile >>"cfgArchives" >> "tickets" >> "level_1","needed")) then {
		ctrlSetText [dialogID, Format ["%1", _lvl_1]];
	};
	if (getNumber(missionConfigFile >>"cfgArchives" >> "tickets" >> "level_1","needed")) then {
		ctrlSetText [dialogID, Format ["%1", _lvl_2]];
	};
	if (getNumber(missionConfigFile >>"cfgArchives" >> "tickets" >> "level_1","needed")) then {
		ctrlSetText [dialogID, Format ["%1", _lvl_3]];
	};
	if (getNumber(missionConfigFile >>"cfgArchives" >> "tickets" >> "level_1","needed")) then {
		ctrlSetText [dialogID, Format ["%1", _lvl_4]];
	};
	if (getNumber(missionConfigFile >>"cfgArchives" >> "tickets" >> "level_1","needed")) then {
		ctrlSetText [dialogID, Format ["%1", _lvl_5]];
	};
*/
