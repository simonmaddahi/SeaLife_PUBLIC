...
if (count _containerInfo isEqualTo 0) exitWith {["Container","Dieser Container ist leer.", true, "fast"] spawn ESG_fnc_notify;};
...
if (_value > 0) then {
    ...
    ["Container","Nichts illegales in diesem Container.", false, "fast"] spawn ESG_fnc_notify;
};
