...
if (player getVariable "restrained") exitWith {["Aktion abgebrochen","Wie willst du mit gefesselten Händen sammeln?", true, "fast"] spawn ESG_fnc_notify};
if (player getVariable "playerSurrender") exitWith {["Aktion abgebrochen","Mit gehobenen Händen kannst du nichts sammeln!", true, "fast"] spawn ESG_fnc_notify};
