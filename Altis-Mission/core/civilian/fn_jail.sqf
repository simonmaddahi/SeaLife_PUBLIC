...
["Lizenzen abgenommen","Bei der Verhaftung hast du folgende Lizenzen verloren, sofern du sie besessen hast:<br/><br/>Waffenlizenz<br/>Rebellenlizenz", false, "fast"] spawn ESG_fnc_notify;
