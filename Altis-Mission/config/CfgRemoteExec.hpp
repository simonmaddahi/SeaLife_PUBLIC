...
class CfgRemoteExec {
    class Functions {
		...
		F(SOCK_fnc_updatePartial, CLIENT)
		F(ESG_fnc_medicSchmerz,CLIENT)
		F(ESG_fnc_hitter,CLIENT)
        F(ESG_fnc_getLicenses,CLIENT)
        F(life_fnc_gangTransferMoney,CLIENT)
        F(life_fnc_updateGangRanks,CLIENT)
        ...
        F(ESG_fnc_changeDBPlate,SERVER)
        F(ESG_fnc_getServerStats,SERVER)
        F(ESG_fnc_applyInsurance,SERVER)
        ...
        F(ESG_fnc_setPlate,ANYONE)
        F(ESG_fnc_notify,ANYONE)
