...
/* System Settings */
    ...
    sendtoJail_locations[] = { "cop_spawn_hq", "cop_spawn_pyrgos", "cop_spawn_kavala"}; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    jail_forceWalk = true;
